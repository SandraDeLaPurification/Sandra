...
public class AdministrateurTest {
    ...
    public void supprimerMaterielDefectueuxAgence_sansMaterielDefectueux() {
        ...
        ((Administrateur) admin).supprimerMaterielDefectueuxAgence(admin.agence);
    ...
    public void achatMateriel() {
        int stockE = e.listeMateriel().size();
        ((Administrateur) admin).achatMateriel(new Clavier());
        Assert.assertEquals("transfererMateriel (envoyeur n'a pas l'objet transféré): fail", stockE + 1, e.listeMateriel().size());
    }
}
